...
- Minimal documentation for users and also about how the code works (for myself & future Devs) (Code comments, commit messages, etc)
...
- 1-day rest after every iteration/sprint/release (max 48 hours/week)
